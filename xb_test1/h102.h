...
// Thu Feb  8 21:34:16 2018 by ROOT version 6.12/04
// from TTree h102/collect hit tree
// found on file: xb_gamma_isotropic_0.1-10_100000.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("xb_gamma_isotropic_0.1-10_100000.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("xb_gamma_isotropic_0.1-10_100000.root");
      }
