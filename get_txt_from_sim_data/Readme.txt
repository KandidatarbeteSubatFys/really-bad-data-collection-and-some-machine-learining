...
dimension. gun-filen innehåller energin, cos(theta) och phi (från -pi till pi) för varje gun. Programmet klarar obegränsat med root-filer sominput. Ska någon simuleringarna bara ha en gun
...
linux-system (och windows). Funkar för både crystal ball och dali2. För crystal ball, ange XB som andra argument, för för dali2 ange dali2.
...
Man behöver inte ordna root-filerna efter antal gun, men är viktigt om du tex vill använda superponeringsprogrammet efteråt.
