...
Should not be limited to one detector, should for example work on both crystal ball and dali2. It uses a simple form of nearest neighbour convolution before the first hidden layer.
...
5) Use make_conv_1try_data_set.py to convert the multiplicity data into data suitable for this kind of convolution.
6) Now you have the data for the program and you're ready to run the program. Open the program and specify the npz
