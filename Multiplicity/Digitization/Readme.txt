...
The benefit with superimposing data from single gun events is that all fired guns will interact with the detector. This program saves the output data as one npz file
...
python3 superimposed_digitalisation_certain_percentage.py 1 7 90 inputfile_crystal_energies.txt inputfile_gun.txt output.npz
