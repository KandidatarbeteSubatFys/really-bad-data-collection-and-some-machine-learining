...
installerade. Programmet fungerar för root av version 6.12/04, men för versionen 6.04/04 fungerar det ej. De filerna som ingår i programmet är gamma_auto_home.py, gamma_root_loop.C, gamma_h102_backup.C och gamma_root_make_class.C.
